...
<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
  <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
      ...
      <div class="flex items-center justify-center">
          <a data-tooltip-target="tooltip-new" href="locations.html" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-pink-400 rounded-full hover:bg-pink-600 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
